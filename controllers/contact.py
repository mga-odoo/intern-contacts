...
def contacts_list(group_key=None, available=False):
    ...
    return render_template('index.html',  groups=group_list(context), contacts=contacts, context=context)
...
def contact_new(contact_edit=None):
    ...
    return render_template('contact.html', groups=group_list(context), contact=contact, context=context)
